...
var Rankings = function (_Component) {
  _inherits(Rankings, _Component);

  function Rankings() {
    _classCallCheck(this, Rankings);

    return _possibleConstructorReturn(this, (Rankings.__proto__ || Object.getPrototypeOf(Rankings)).apply(this, arguments));
  }
...
_reactDom2.default.render(_react2.default.createElement(Rankings, null), document.getElementById('app'));
...
//# sourceMappingURL=/canes-rankings.4ab252e8.map